			...
			echo '<div class="col-xs-12 col-sm-6 col-md-3">';
				echo '<div class="releaseEintrag">';
					...
					echo '<div class="releaseEintragTitel">';
						renderHeadline('<a href="uploads/' . getFileName($entry['datei'], 0) . '" download="' .  getFileName($entry['datei'], 1) . '"><span class="interpret">' . $entry['interpret'] . '</span><span class="title">' . $entry['titel'] . '</span></a>', 3, null);
					echo '</div>';
